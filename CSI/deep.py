...
# 1. Load data
df1 = pd.read_csv('Site 1-Deep.csv', sep=';')
df2 = pd.read_csv('Site 2-Deep.csv', sep=';')
df3 = pd.read_csv('Site 3-Deep.csv', sep=';')
df5 = pd.read_csv('Site 5-Deep.csv', sep=';')
...
ax.set_title('Deep Depth Conductivity Over Time\n(Site 1, 2, 3, and 5)', fontsize=14)
ax.grid(True)
