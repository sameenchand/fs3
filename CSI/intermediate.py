...
# 1. Load data
df1 = pd.read_csv('Site 1-Intermediate.csv', sep=';')
df2 = pd.read_csv('Site 2-Intermediate.csv', sep=';')
df3 = pd.read_csv('Site 3-Intermediate.csv', sep=';')
df5 = pd.read_csv('Site 5-Intermediate.csv', sep=';')
...
ax.set_title('Intermediate Depth Conductivity Over Time\n(Site 1, 2, 3, and 5)', fontsize=14)
ax.grid(True)
